...
public class SpeedHarvest
{
    ...
    {
        String s = event.getWorld().getBlockState(event.getPos()).getBlock().getClass().getName().toString();// .getBlock().toString();
        event.getEntityPlayer().sendMessage(new TextComponentString(s));
    }
    */
